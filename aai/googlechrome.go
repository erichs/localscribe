...
// pollChromeHistory spawns a goroutine that every 10 minutes:
...
func pollChromeHistory(cfg Config) error {
	...
	for {
		...
		case <-cfg.Context.Done():
			...
			return nil
		case <-ticker.C:
			if err := processChromeDBHistory(cfg); err != nil {
...
// processChromeDBHistory does the actual copying, querying, and log emission.
func processChromeDBHistory(cfg Config) error {
